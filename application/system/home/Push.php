...
class Push extends Common
{
    protected function initialize() {
        ...
        $this->cloud        = new CloudApi(config('mg_cloud.identifier'), $this->updatePath);
    ...
    public function module()
    {
        ...
        // 检查模块名是否为系统限制名称
        if (in_array($this->appName, config('mg_system.config')) !== false) {
    ...
    public function plugins()
    {
        ...
        // 复制静态资源
        Dir::copyDir($staticPath, './static/plugins/'.$this->appName);
