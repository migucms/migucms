...
<link rel="stylesheet" href="__ADMIN_CSS__/common.min.css">
<style type="text/css">
    ...
    <div style="text-align:center;">
        <div class="dispatch-box">
            <div class="dispatch-message">
                <?php switch ($code) {?>
                    <?php case 1:?>
                        <div class="success"><i class="hs-icon hs-icon-success">&nbsp;</i><span><?php echo($msg);?></span></div>
                    <?php break;?>
                    <?php case 0:?>
                        <div class="error"><i class="hs-icon hs-icon-error">&nbsp;</i><span><?php echo($msg);?></span></div>
                    <?php break;?>
                <?php } ?>
            </div>
